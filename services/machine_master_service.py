...
from repositories.machine_master_repository import (
    machine_master_repository,
)

from services.base_service import BaseService


class MachineMasterService(BaseService):

    def __init__(self):

        self.repo = machine_master_repository
...
machine_master_service = MachineMasterService()